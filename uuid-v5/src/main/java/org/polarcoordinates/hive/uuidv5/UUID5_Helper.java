...
/**
 *
 * Copied directly from <a href=https://github.com/rootsdev/polygenea/blob/master/java/src/org/rootsdev/polygenea/UUID5.java>here</a>
 *
...
public class UUID5_Helper {
    ...
    public static UUID fromUTF8(String name) {
        return UUID5_Helper.fromBytes(name.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static UUID fromUTF8(UUID namespace, String name) {
        return UUID5_Helper.fromBytes(namespace, name.getBytes(Charset.forName("UTF-8")));
    }
